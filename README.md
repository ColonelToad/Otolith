...
| v0.4 | RTL port: fixed-point predict pipeline → Verilator parity → Yosys → LibreLane/SKY130 PPA | **M4-closed** — ADR-0007: Q8.24+Q16.48 (range-measured), 2500/2500 full-core parity, ECP5 Fmax 65.8 MHz, kernel GDS (0.119 mm², DRC/antenna clean, Fmax ~67 MHz TT), full-core cost 3.40 mm²; Cholesky/docs M5–M6 open |
