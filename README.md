...
| v0.4 | RTL port: fixed-point predict pipeline → Verilator parity → Yosys → LibreLane/SKY130 PPA | **in progress** — ADR-0007: Q8.24+64b accum (range-measured), Cholesky stretch |
